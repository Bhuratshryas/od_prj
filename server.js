...
app.post('/process-image', upload.single('image'), async (req, res) => {
  try {
    ...
    const { 
      name_prompt: includeName, 
      expiration_range: includeRange, 
      brand_name: includeBrand, 
      mold_detection: includeMold, 
      quick_recipe: includeRecipe 
    } = userSettings;
    ...
    if (aiResponse) {
      ...
      if (parts.includes("I'm sorry") || parts.includes("I can't identify any object in the image.")) {
